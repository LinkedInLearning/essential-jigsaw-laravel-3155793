    ...
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <div class="flex my-10">
                <a href="/docs/getting-started" title="{{ $page->siteName }} getting started" class="bg-green-500 hover:bg-green-600 font-normal text-white hover:text-white rounded mr-4 py-2 px-6">Get Started</a>
